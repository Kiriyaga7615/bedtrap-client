package bedtrap.development.systems.modules.other.FakePlayer;
...
import bedtrap.development.systems.modules.combat.Aura.Aura;
...
@Module.Info(name = "FakePlayer", category = Module.Category.Other)
public class FakePlayer extends Module {
    ...
    public void onActivate() {
        fakePlayer = new OtherClientPlayerEntity(mc.world, new GameProfile(UUID.fromString("c3924bf3-181b-4f91-a955-34314643cb85"), "tyrannus00"));
    ...
    public void onTick(TickEvent.Post event) {
        ...
        if ((mc.targetedEntity == fakePlayer && mc.options.attackKey.isPressed()) || (Aura.instance.isActive() && Aura.instance.target == fakePlayer && mc.player.handSwinging)) {
            ...
            damage += (float) DamageUtils.getSwordDamage(fakePlayer) / 3;
            setHealth(damage);
        }
