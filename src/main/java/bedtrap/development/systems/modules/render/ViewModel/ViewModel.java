package bedtrap.development.systems.modules.render.ViewModel;
...
public class ViewModel extends Module {
    ...
    // Swing
    public Setting<String> swingMode = register("Swing", List.of("OffHand", "MainHand", "None"), "None");
