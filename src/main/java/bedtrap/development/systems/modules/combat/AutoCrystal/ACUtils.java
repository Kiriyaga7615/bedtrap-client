...
import bedtrap.development.mixininterface.IMinecraftClient;
...
public class ACUtils {
    ...
    public static Vec3d closestVec3d(BlockPos blockpos) {
        ...
        double x = MathHelper.clamp(eyePos.getX() - blockpos.getX(), 0.0, 1.0);
        double y = MathHelper.clamp(eyePos.getY() - blockpos.getY(), 0.0, 0.6);
        double z = MathHelper.clamp(eyePos.getZ() - blockpos.getZ(), 0.0, 1.0);
    ...
    public static void processAttack(Entity entity) {
        ...
        mc.crosshairTarget = new EntityHitResult(entity, closestVec3d(entity));
        leftClick();
